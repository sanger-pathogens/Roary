...
has '_chunk_fasta_file_obj'   => ( is => 'ro', isa => 'ArrayRef', lazy => 1, builder => '_build__chunk_fasta_file_obj' );
has '_sequence_file_names'    => ( is => 'ro', isa => 'ArrayRef', lazy => 1, builder => '_build__sequence_file_names' );
has '_makeblastdb_obj'        => ( is => 'ro', isa => 'ArrayRef', lazy => 1, builder => '_build__makeblastdb_obj' );
...
sub _build__sequence_file_names {
    my ($self) = @_;
    $self->_chunk_fasta_file_obj->sequence_file_names;
}
