...
is($obj->_command_to_run, $cwd.'/t/bin/dummy_cd-hit -i t/data/some_fasta_file.fa -o output -T 1 -M 1000 -g 1 -s 0.99 -c 0.99 2> /dev/null', 'Command constructed as expected');
