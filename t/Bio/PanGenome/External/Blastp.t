...
is($obj->_command_to_run, $cwd.'/t/bin/dummy_blastp -query t/data/some_fasta_file.fa -db some_blast_database -evalue 1e-06 -num_threads 1 -out results.out -outfmt 6 -max_target_seqs 5000 2> /dev/null', 'Command constructed as expected');
