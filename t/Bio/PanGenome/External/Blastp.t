...
is($obj->_command_to_run, $cwd.'/t/bin/dummy_blastp -query t/data/some_fasta_file.fa -db some_blast_database -evalue 1e-06 -num_threads 1 -outfmt 6 -max_target_seqs 2000  | awk \'{ if ($3 > 95) print $0;}\' 2> /dev/null 1>  results.out', 'Command constructed as expected');
