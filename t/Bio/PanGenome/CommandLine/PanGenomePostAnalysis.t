...
my %scripts_and_expected_files = (
       '-o clustered_proteins -p pan_genome.fa -s group_statisics.csv -c _clustered.clstr  -i _gff_files -f _fasta_files  -j Local --dont_create_rplots --dont_split_groups' =>
...
%scripts_and_expected_files = (
       '-t 1 -o clustered_proteins -p pan_genome.fa -s group_statisics.csv -c _clustered.clstr  -i _gff_files -f _fasta_files  -j Local --dont_create_rplots --dont_split_groups' =>
       [ 'clustered_proteins', 't/data/clustered_proteins_post_analysis' ], 
       '-h' =>
         [ 'empty_file', 't/data/empty_file' ],   
);
